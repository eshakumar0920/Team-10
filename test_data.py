...
def create_test_data():
    with app.app_context():
        # Wrap everything in a no_autoflush block to prevent premature flushing
        with db.session.no_autoflush:
            ...
            # Create test users
            users = [
                {"username": "testuser1", "email": "user1@example.com", "password_hash": "password"},
                {"username": "testuser2", "email": "user2@example.com", "password_hash": "password"}
            ]
